package com.example.android.demoapp.CustomView;
...
public class ClearEditText extends AppCompatEditText {
    ...
    private void khoitao(){
        ...
        nonecrossx = Objects.requireNonNull(ContextCompat.getDrawable(getContext(), android.R.drawable.screen_background_light_transparent)).mutate();
